...
const NavBar = ({ navAppear }) => {
  return (
    <>
      <nav
        className={` ${!navAppear ? "hidden" : ""} absolute md:relative top-full md:top-0 left-0 md:flex items-center w-full md:w-fit bg-white md:bg-transparent shadow-lg text-sm md:shadow-none rounded-b-lg`}
      >
